...
const data = [
  ...
  },
  {
    ...
    secondParagraph: `Dagobah hutt jawa leia calamari ventress skywalker yoda. Binks wicket hutt coruscant sidious
    naboo ackbar tatooine. Hutt lars padmé darth. Maul solo darth darth jabba qui-gon chewbacca darth maul. Moff baba wicket
    han. C-3po antilles moff qui-gon ahsoka aayla dooku amidala. Palpatine droid amidala droid k-3po twi'lek padmé wookiee. Leia
    moff calamari mon obi-wan. Solo grievous lando coruscant. Jinn darth palpatine obi-wan mon.`,
...
function createArticle(title, date, c1, c2, c3) {
  ...
  parent.append(articleName);
  parent.append(articleDate);
  parent.append(p1, p2, p3);
  parent.append(articleBtn);

  parent.classList.add("article");
  articleDate.classList.add("date");
  articleBtn.classList.add("expandButton");

  articleBtn.textContent = "More Info";
